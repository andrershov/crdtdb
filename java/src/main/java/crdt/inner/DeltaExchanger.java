...
public class DeltaExchanger {
    private final DeltaStorage storage;
    private final List<? extends NodeConnection> nodes;
    private final CrdtDbImpl db;
    private final Map<String, Map<String, Integer>> globalAckMap = new HashMap<>();
